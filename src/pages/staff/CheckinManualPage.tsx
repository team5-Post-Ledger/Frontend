    ...
    >
      ...
      <div className="flex shrink-0 flex-col items-end gap-1">
        ...
        {candidate.checkinStatus === 'CHECKED_IN' && (
          <span className="bg-warning px-2 py-0.5 text-[11px] font-bold text-white">이미 체크인</span>
        )}
      </div>
    </button>
  )
          ...
          {candidates !== null && (
            <div className="border border-line bg-white p-5">
              <div className="mb-3 flex items-center justify-between gap-3">
                ...
                {candidates.length > 1 && (
                  <span className="text-xs text-muted">동명이인일 수 있습니다. 전화·예약번호를 확인하세요.</span>
                )}
              </div>
          ...
          <div className="border border-line bg-white p-5">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <span className="bg-surface px-2.5 py-1 text-[11px] font-bold text-ink">
                {selected.movementMode === 'GROUP' ? '그룹' : '개인'}
              </span>
